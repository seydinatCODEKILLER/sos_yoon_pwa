...
const screens = [
  { key: "record", label: "Décrire" },
  { key: "triage", label: "Triage" },
  { key: "connect", label: "Mise en relation" },
];
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4 px-6">
      ...
      <motion.div
        ...
        className="max-w-[85%] self-start rounded-2xl rounded-tl-sm bg-paper/10 px-4 py-2.5 text-left text-sm text-paper/80"
      >
      ...
      <motion.div
        ...
        className="inline-flex items-center gap-1.5 rounded-full bg-signal px-4 py-1.5 text-sm font-medium text-ink"
      >
        5 minutes
      </motion.div>
    </div>
    ...
    <section className="bg-ink py-24 text-paper md:py-32">
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-16 px-6 md:grid-cols-2">
              ...
              >
                <span
                  className={`h-1.5 flex-1 max-w-10 rounded-full transition-all duration-300 ${
                    i === index
                      ? "bg-signal"
                      : "bg-paper/15 group-hover:bg-paper/30"
                  }`}
                />
                <span
        ...
        <AnimatedSection direction="right" className="mx-auto">
          <div className="relative">
            <div className="absolute inset-0 -z-10 rounded-full bg-signal/10 blur-3xl" />

            <div className="relative h-130 w-65 rounded-[2.5rem] border-8 border-paper/10 bg-black/60 p-2 shadow-2xl">
              {/* boutons latéraux */}
